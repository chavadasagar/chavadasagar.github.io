...
window.DEVDOCS_SUBJECTS['kotlin'] = [
    {
        ...
        "extracted_at": "2026-08-09T11:15:16Z",
        "subject": "Kotlin",
        "title": "Kotlin Tutorial"
    },
    {
        "url": "https://www.w3schools.com/kotlin/kotlin_intro.php",
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_intro",
        "code_examples": [],
        "category": "Backend & Programming",
        "notes_and_tips": [],
        "sections": [
        ...
        "extracted_at": "2026-08-09T11:15:17Z",
        "subject": "Kotlin",
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "content": "In the previous chapter, we created a Kotlin file called Main.kt, and we used the following code to print \"Hello World\" to the screen:\n\nExample\nfun main() {\n println(\"Hello World\")\n}\nTry it Yourself »\n\nExample explained\n\nThe fun keyword is used to declare a function. A function is a block of code designed to perform a particular task. In the example above, it declares the main() function.\n\nThe main() function is something you will \nsee in every Kotlin program. This function is used to execute code. Any code inside the main() function's curly brackets {} will be executed.\n\nFor example, the println() function is inside the main() function, meaning that this will be executed. The println() function is used to output/print text, and in our example it will output \"Hello World\".\n\nGood To Know: In Kotlin, code statements do not have to end with a semicolon (;) (which is often required for other programming languages, such as Java, C++, C#, etc.).",
                "heading": "Kotlin Syntax"
            },
            {
                "content": "Before Kotlin version 1.3, it was required to use the main() function with parameters, like: fun main(args : Array<String>). \nThe example above had to be written like this to work:\n\nExample\nfun main(args : Array<String>) {\n println(\"Hello World\")\n}\nTry it Yourself »\n\nNote: This is no longer required, and the program will run fine without it. However, it will not do any harm if you have been using it in the past, and will continue to use it.",
                "heading": "Main Parameters"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "content": "The println() function is used to output values/print text:\n\nExample\nfun main() {\n println(\"Hello World\")\n}\nTry it Yourself »\n\nYou can add as many println() functions as you want. Note that it will add a new line for each function:\n\nExample\nfun main() {\n println(\"Hello World!\")\n println(\"I am learning Kotlin.\")\n println(\"It is awesome!\")\n}\nTry it Yourself »\n\nYou can also print numbers, and perform mathematical calculations:\n\nExample\nfun main() {\n println(3 + 3)\n}\nTry it Yourself »",
                "heading": "Kotlin Output (Print)"
            },
            {
                "content": "There is also a print() function, which is similar to println(). The only difference is that it does not insert a new line at the end of the output:\n\nExample\nfun main() {\n print(\"Hello World! \")\n print(\"I am learning Kotlin. \")\n print(\"It is awesome!\")\n}\nTry it Yourself »\n\nNote that we have added a space character to create a space between the sentences.",
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_comments",
        "code_examples": [
            {
        ...
        "sections": [
            ...
            {
                "content": "Comments can be used to explain Kotlin code, and to make it more readable. It can also be used to \nprevent execution when testing alternative code.",
                "heading": "Kotlin Comments"
            },
            {
                "content": "Single-line comments starts with two forward slashes (//).\n\nAny text between // and the end of the line \nis ignored by Kotlin (will not be executed).\n\nThis example uses a single-line comment before a line of code:\n\nExample\n// This is a comment\nprintln(\"Hello World\") \nTry it Yourself »\n\nThis example uses a single-line comment at the end of a line of code:\n\nExample\nprintln(\"Hello World\")  // This is a comment\nTry it Yourself »",
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_variables",
        "code_examples": [
            {
        ...
        "sections": [
            ...
            },
            {
                ...
                "heading": "Kotlin Variables"
            },
            {
                "content": "Unlike many other programming languages, variables in Kotlin do not need to be declared with a specified \ntype (like \"String\" for text or \"Int\" for numbers, if you are familiar with those).\n\nTo create a variable in Kotlin that should store text and another that should store a number, look at the following example:\n\nExample\nvar name = \"John\"      // String (text)\nval birthyear = 1975   // Int (number)\n\nprintln(name)          // Print the value of name\nprintln(birthyear)     // Print the value of birthyear\nTry it Yourself »\n\nKotlin is smart enough to understand that \"John\" is a String (text), and that 1975 is an Int \n(number) variable.\n\nHowever, it is possible to specify the type if you insist:\n\nExample\nvar name: String = \"John\" // String\nval birthyear: Int = 1975 // Int\n\nprintln(name)\nprintln(birthyear)\nTry it Yourself »\n\nYou can also declare a variable without assigning the value, and assign the \nvalue later. However, this is only possible when you specify the type:\n\n Example\n This works fine:\n\n var name: String\nname = \"John\"\nprintln(name)\n Try it Yourself »\n\n Example\n This will generate an error:\n\n var name\nname = \"John\"\nprintln(name)\n Try it Yourself »\n\nNote: You will learn more about Data Types in the next chapter.",
                "heading": "Variable Type"
            },
            {
                "content": "When you create a variable with the val keyword, the value \n cannot be changed/reassigned.\n\n The following example will generate an error:\n\n Example\nval name = \"John\"\nname = \"Robert\"  // Error (Val cannot be reassigned)\nprintln(name)\n Try it Yourself »\n\nWhen using var, you can change the value whenever you want:\n\nExample\nvar name = \"John\"\nname = \"Robert\"\nprintln(name)\nTry it Yourself »\n\n So When To Use val?\n The val keyword is useful when you want a variable to always store the same value, like PI (3.14159...):\n\nExample\nval pi = 3.14159265359\nprintln(pi)\nTry it Yourself »\n\nTip: Keep in mind that it is much safer to create variables that can't be changed, as they can't be overwritten by other programs or people.\n\n-->",
                "heading": "Notes on val"
            },
            {
                "content": "Like you have seen with the examples above, the println() method is often used to display variables.\n\nTo combine both text and a variable, use the + character:\n\nExample\nval name = \"John\"\nprintln(\"Hello \" + name)\nTry it Yourself »\n\nYou can also use the + character to add a variable to another variable:\n\nExample\nval firstName = \"John \"\nval lastName = \"Doe\"\nval fullName = firstName + lastName\nprintln(fullName)\nTry it Yourself »\n\nFor numeric values, the + character works as \na mathematical operator:\n\nExample\nval x = 5\nval y = 6\nprintln(x + y) // Print the value of x + y \nTry it Yourself »\n\nFrom the example above, you can expect:\n\n x stores the value 5\n\n y stores the value 6\n\n Then we use the println() method to display the value of x + y, \n which is 11",
                "heading": "Display Variables"
            },
            {
                "content": "A variable can have a short name (like x and y) or more descriptive names (age, sum, totalVolume).\n\nThe general rule for Kotlin variables are:\n\n Names can contain letters, digits, underscores, and dollar signs\n\n Names should start with a letter\n\n Names can also begin with $ and _ (but we will not use it in this tutorial)\n\n Names are case sensitive (\"myVar\" and \"myvar\" are different variables)\n\n Names should start with a lowercase letter and it cannot contain whitespace\n\n Reserved words (like Kotlin keywords, such as \n var or \n String) cannot be used as names\n\ncamelCase variables\nYou might notice that we used firstName and lastName as variable names in the example above, instead of firstname and lastname. This is called \"camelCase\", and it is considered as good practice as it makes it easier to read when you have a variable name with different words in it, for example \"myFavoriteFood\", \"rateActionMovies\" etc.\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
        ...
        "extracted_at": "2026-08-09T11:15:18Z",
        "subject": "Kotlin",
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_data_types",
        "code_examples": [
            {
        ...
        "sections": [
            ...
            {
                "content": "In Kotlin, the type of a variable is decided by its value:\n\nExample\nval myNum = 5             // Int\nval myDoubleNum = 5.99    // Double\nval myLetter = 'D'        // Char\nval myBoolean = true      // Boolean\nval myText = \"Hello\"      // String\nTry it Yourself »\n\nHowever, you learned from the previous chapter that it is possible to specify the type if you want:\n\nExample\nval myNum: Int = 5                // Int\nval myDoubleNum: Double = 5.99    // Double\nval myLetter: Char = 'D'          // Char\nval myBoolean: Boolean = true     // Boolean\nval myText: String = \"Hello\"      // String\nTry it Yourself »\n\nSometimes you have to specify the type, and often you don't. Anyhow, it is \ngood to know what the different types represent.\nYou will learn more about when you need to specify the type later.\n\nData types are divided into different groups:\n\n Numbers\n\n Characters\n\n Booleans\n\n Strings\n\n Arrays",
                "heading": "Kotlin Data Types"
            },
            {
                "content": "Number types are divided into two groups:\n\nInteger types store whole numbers, positive or negative (such as 123 or -456), without decimals. \nValid types are Byte, \nShort, Int \nand Long.\n\nFloating point types represent numbers with a fractional part, \ncontaining one or more decimals. There are two types: \nFloat and Double.\n\nIf you don't specify the type for a numeric variable, it is most often \nreturned as Int for whole numbers and Double for floating point numbers.",
                "heading": "Numbers"
            },
            {
                "content": "Byte\nThe Byte data type can store whole numbers \nfrom -128 to 127. This can be used instead of Int or other integer types to \nsave memory when you are certain that the value will be within -128 and 127:\n\nExample\nval myNum: Byte = 100\nprintln(myNum)\nTry it Yourself »\n\nShort\nThe Short data type can store whole numbers from -32768 to 32767:\n\nExample\nval myNum: Short = 5000\nprintln(myNum)\nTry it Yourself »\n\nInt\nThe Int data type can store whole numbers \nfrom -2147483648 to 2147483647:\n\nExample\nval myNum: Int = 100000\nprintln(myNum)\nTry it Yourself »\n\nLong\nThe Long data type can store whole numbers from -9223372036854775808 to 9223372036854775807. This is used when \nInt is not large enough to store the value. \nOptionally, you can end the value with an \"L\":\n\nExample\nval myNum: Long = 15000000000L\nprintln(myNum)\nTry it Yourself »",
            ...
            {
                "content": "A whole number is an Int as long as it is up to 2147483647. If it goes beyond \nthat, it is defined as Long:\n\nExample\nval myNum1 = 2147483647  // Int\nval myNum2 = 2147483648  // Long",
                "heading": "Difference Between Int and Long"
            },
            {
                "content": "Floating point types represent numbers with a decimal, such as 9.99 or 3.14515.\n\nThe Float and Double data types can store fractional numbers:\n\nFloat Example\nval myNum: Float = 5.75F\nprintln(myNum)\nTry it Yourself »\n\nDouble Example\nval myNum: Double = 19.99\nprintln(myNum)\nTry it Yourself »\n\nUse Float or Double?\n\nThe precision of a floating point value indicates how many digits the value can have \nafter the decimal point.\nThe precision of Float is only six or seven \ndecimal digits, while Double variables have a precision \nof about 15 digits. Therefore it is safer to use Double for most calculations.\n\nAlso note that you should end the value of a Float type with an \"F\".\n\nScientific Numbers\nA floating point number can also be a scientific number with an \"e\" or \"E\" to indicate the power of 10:\n\nExample\nval myNum1: Float = 35E3F\nval myNum2: Double = 12E4\nprintln(myNum1)\nprintln(myNum2)\nTry it Yourself »",
                "heading": "Floating Point Types"
            },
            {
                "content": "The Boolean data type can only take the values true or false:\n\nExample\nval isKotlinFun: Boolean = true\nval isFishTasty: Boolean = false\nprintln(isKotlinFun)   // Outputs true\nprintln(isFishTasty)   // Outputs false \nTry it Yourself »\n\nBoolean values are mostly used for conditional testing, which you will learn more about in a later chapter.",
                "heading": "Booleans"
            },
            {
                "content": "The Char data type is used to store a \nsingle character. A char value must be \nsurrounded by single quotes, like 'A' or 'c':\n\nExample\nval myGrade: Char = 'B'\nprintln(myGrade)\nTry it Yourself »\n\nUnlike Java, you cannot use ASCII values to display certain characters. The \nvalue 66 would output a \"B\" in Java, but will generate an error in Kotlin:\n\nExample\nval myLetter: Char = 66\nprintln(myLetter) // Error",
                "heading": "Characters"
            },
            {
                "content": "The String data type is used to store a sequence of characters (text). String values must be surrounded by \ndouble quotes:\n\nExample\nval myText: String = \"Hello World\"\nprintln(myText)\nTry it Yourself »\n\nYou will learn more about strings in the Strings chapter.",
                "heading": "Strings"
            },
            {
            ...
            {
                "content": "Type conversion is when you convert the value of one data type to another type.\n\nIn Kotlin, numeric type conversion is different from Java. For example, it is not possible to convert an Int type to a Long type with the following code:\n\nExample\nval x: Int = 5\nval y: Long = x\nprintln(y) // Error: Type mismatch \nTry it Yourself »\n\nTo convert a numeric data type to another type, you must use one of the following functions: toByte(), toShort(), toInt(), toLong(), toFloat(), toDouble() or toChar():\n\nExample\nval x: Int = 5\nval y: Long = x.toLong()\nprintln(y)\nTry it Yourself »\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
    ...
    },
    {
        ...
        "sections": [
            ...
            },
            {
                ...
                "heading": "Kotlin Operators"
            },
            {
                "content": "Arithmetic operators are used to perform common mathematical operations.\n\nOperator\nName\nDescription\nExample\nTry it\n\n+\nAddition\nAdds together two values\nx + y\nTry it »\n\n-\nSubtraction\nSubtracts one value from another\nx - y\nTry it »\n\n*\nMultiplication\nMultiplies two values\nx * y\nTry it »\n\n/\nDivision\nDivides one value from another\nx / y\nTry it »\n\n%\nModulus\nReturns the division remainder\nx % y\nTry it »\n\n++\nIncrement\nIncreases the value by 1\n++x\nTry it »\n\n--\nDecrement\nDecreases the value by 1\n--x\nTry it »",
                "heading": "Arithmetic Operators"
            },
            {
                "content": "Assignment operators are used to assign values to variables.\n\nIn the example below, we use the assignment operator (=) \nto assign the value 10 to a variable called x:\n\nExample\nvar x = 10\nTry it Yourself »\n\nThe addition assignment operator (+=) adds a value to a variable:\n\nExample\nvar x = 10\nx += 5\nTry it Yourself »\n\nA list of all assignment operators:\n\nOperator\nExample\nSame As\nTry it\n\n=\nx = 5\nx = 5\nTry it »\n\n+=\nx += 3\nx = x + 3\nTry it »\n\n-=\nx -= 3\nx = x - 3\nTry it »\n\n*=\nx *= 3\nx = x * 3\nTry it »\n\n/=\nx /= 3\nx = x / 3\nTry it »\n\n%=\nx %= 3\nx = x % 3\nTry it »",
                "heading": "Kotlin Assignment Operators"
            },
            {
                "content": "Comparison operators are used to compare two values, and returns a Boolean \nvalue: either true or false.\n\nOperator\nName\nExample\nTry it\n\n==\nEqual to\nx == y\nTry it »\n\n!=\nNot equal\nx != y\nTry it »\n\n>\nGreater than\nx > y\nTry it »\n\n<\nLess than\nx < y\nTry it »\n\n>=\nGreater than or equal to\nx >= y\nTry it »\n\n<=\nLess than or equal to\nx <= y\nTry it »\n\nYou will learn much more about Booleans in the Boolean chapter and \nConditions.",
                "heading": "Kotlin Comparison Operators"
            },
            {
                "content": "Logical operators are used to determine the logic between variables or \nvalues:\n\nOperator\nName\nDescription\nExample\nTry it\n\n&& \nLogical and\nReturns true if both statements are true\nx < 5 &&  x < 10\nTry it »\n\n|| \nLogical or\nReturns true if one of the statements is true\nx < 5 || x < 4\nTry it »\n\n!\nLogical not\nReverse the result, returns false if the result is true\n\nTry it »\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                "heading": "Kotlin Logical Operators"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "content": "Strings are used for storing text.\n\nA string contains a collection of characters surrounded by double quotes:\n\nExample\nvar greeting = \"Hello\"\nTry it Yourself »\n\nUnlike Java, you do not have to specify that the variable should be a String. Kotlin is smart enough to understand that the greeting variable in the example \nabove is a String because of the double quotes.\n\nHowever, just like with other data types, you can specify the type if you insist:\n\nExample\nvar greeting: String = \"Hello\"\nTry it Yourself »\n\nNote: If you want to create a String without assigning the value (and assign the value later), you must specify the type while declaring the variable:\n\nExample\nThis works fine:\n\nvar name: String\nname = \"John\"\nprintln(name)\nTry it Yourself »\n\nExample\nThis will generate an error:\n\nvar name\nname = \"John\"\nprintln(name)\nTry it Yourself »",
                "heading": "Kotlin Strings"
            },
            {
                "content": "To access the characters (elements) of a string, you must refer to the index number \ninside square brackets.\n\nString indexes start with 0. In the example below, we access the first and third element in \ntxt:\n\nExample\nvar txt = \"Hello World\"\nprintln(txt[0]) // first element (H)\nprintln(txt[2]) // third element (l)\nTry it Yourself »\n\n[0] is the first element. [1] is the second element, [2] is the third element, etc.",
                "heading": "Access a String"
            },
            {
                "content": "A String in Kotlin is an object, which contain properties and functions that can perform certain operations on strings, \nby writing a dot character (.) after the specific string variable. For example, the length of a string can be found with the length \nproperty:\n\nExample\nvar txt = \"ABCDEFGHIJKLMNOPQRSTUVWXYZ\"\nprintln(\"The length of the txt string is: \" + txt.length)\nTry it Yourself »",
                "heading": "String Length"
            },
            {
                "content": "There are many string functions available, for example \nuppercase() and lowercase():\n\nExample\nvar txt = \"Hello World\"\nprintln(txt.uppercase())   // Outputs \"HELLO WORLD\"\nprintln(txt.lowercase())   // Outputs \"hello world\"\nTry it Yourself »",
                "heading": "String Functions"
            },
            {
                "content": "The compareTo(string) function \ncompares two strings and returns 0 if both are equal:\n\nExample\nvar txt1 = \"Hello World\"\nvar txt2 = \"Hello World\"\nprintln(txt1.compareTo(txt2))  // Outputs 0 (they are equal)\nTry it Yourself »",
                "heading": "Comparing Strings"
            },
            {
                "content": "The indexOf() function returns the index (the position) \nof the first occurrence of a specified text in a string \n(including whitespace):\n\nExample\nvar txt = \"Please locate where 'locate' occurs!\"\nprintln(txt.indexOf(\"locate\"))  // Outputs 7\nTry it Yourself »\n\nRemember that Kotlin counts positions from zero.\n0 is the first position in a \nstring, 1 is the second, 2 is the third ...",
                "heading": "Finding a String in a String"
            },
            {
                "content": "To use quotes inside a string, use single quotes ('):\n\nExample\nvar txt1 = \"It's alright\"\nvar txt2 = \"That's great\"\nTry it Yourself »",
                "heading": "Quotes Inside a String"
            },
            {
                "content": "The + operator can be used between strings to add them together to make a new \nstring. This is called concatenation:\n\nExample\nvar firstName = \"John\"\nvar lastName = \"Doe\"\nprintln(firstName + \" \" + lastName)\nTry it Yourself »\n\nNote that we have added an empty text (\" \") to create a space between firstName and lastName on print.\n\nYou can also use the plus() function to concatenate two strings:\n\nExample\nvar firstName = \"John \"\nvar lastName = \"Doe\"\nprintln(firstName.plus(lastName))\nTry it Yourself »",
                "heading": "String Concatenation"
            },
            {
                "content": "Instead of concatenation, you can also use \"string templates\", which is an \neasy way to add variables and expressions inside a string.\n\nJust refer to the variable with the $ symbol:\n\nExample\nvar firstName = \"John\"\nvar lastName = \"Doe\"\nprintln(\"My name is $firstName $lastName\")\nTry it Yourself »\n\n\"String Templates\" is a popular feature of Kotlin, as it reduces the amount \nof code. For example, you do not have to specify a whitespace between firstName \nand lastName, like we did in the concatenation example.\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                "heading": "String Templates/Interpolation"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_booleans",
        "code_examples": [
            {
        ...
        "sections": [
            ...
            },
            {
                ...
                "heading": "Kotlin Booleans"
            },
            {
                "content": "A boolean type can be declared with the Boolean keyword and can only take the values true or false:\n\nExample\nval isKotlinFun: Boolean = true\nval isFishTasty: Boolean = false\nprintln(isKotlinFun)   // Outputs true\nprintln(isFishTasty)   // Outputs false \nTry it Yourself »\n\nJust like you have learned with other data types in the previous chapters, the example above can also be written without specifying the type, as Kotlin is smart enough to understand that the variables are Booleans:\n\nExample\nval isKotlinFun = true\nval isFishTasty = false\nprintln(isKotlinFun)   // Outputs true\nprintln(isFishTasty)   // Outputs false \nTry it Yourself »",
                "heading": "Boolean Values"
            },
            {
                "content": "A Boolean expression returns a Boolean value: true or false.\n\nYou can use a comparison operator, such as the greater than (>) operator to find out if an expression (or a variable) is true:\n\nExample\nval x = 10\nval y = 9\nprintln(x > y) // Returns true, because 10 is greater than 9\nTry it Yourself »\n\nOr even easier:\n\nExample\nprintln(10 > 9) // Returns true, because 10 is greater than 9\nTry it Yourself »\n\nIn the examples below, we use the equal to (==) operator to evaluate an expression:\n\nExample\nval x = 10;\nprintln(x == 10); // Returns true, because the value of x is equal to 10\nTry it Yourself »\n\nExample\nprintln(10 == 15); // Returns false, because 10 is not equal to 15\nTry it Yourself »\n\nThe Boolean value of an expression is the basis for all Kotlin comparisons and conditions.\n\nYou will learn more about conditions in the next chapter.\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
        ...
        "extracted_at": "2026-08-09T11:15:19Z",
        "subject": "Kotlin",
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "content": "You already know that Kotlin supports familiar comparison conditions from mathematics, such as:\n\nLess than: a < b\n\nLess than or equal to: a <= b\n\nGreater than: a > b\n\nGreater than or equal to: a >= b\n\nEqual to a == b\n\nNot Equal to: a != b\n\nYou can use these conditions to perform different actions for different decisions.\n\nKotlin has the following conditionals:\n\n Use if to specify a block of code to be executed, if a specified condition is true\n\n Use else to specify a block of code to be executed, if the same condition is false\n\n Use else if to specify a new condition to test, if the first condition is false\n\n Use when to specify many alternative blocks of code to be executed\n\nNote: Unlike Java, if..else can be used as a \nstatement or as an expression (to assign a \nvalue to a variable) in Kotlin. See \nan example at the bottom of the page to better understand it.",
                "heading": "Kotlin Conditions and If..Else"
            },
            {
                "content": "Use if to specify a block of code to be executed if a condition is true.\n\nSyntax\nif (condition) {\n // block of code to be executed if the condition is true\n}\n\nNote that if is in lowercase letters. Uppercase letters (If or IF) will generate an error.\n\nIn the example below, we test two values to find out if 20 is greater than \n18. If the condition is true, print some text:\n\nExample\nif (20 > 18) {\n  println(\"20 is greater than 18\")\n}\nTry it Yourself »\n\nWe can also test variables:\n\nExample\nval x = 20\nval y = 18\nif (x > y) {\n println(\"x is greater than y\")\n}\nTry it Yourself »\n\nExample explained\nIn the example above we use two variables, x and y, \nto test whether x is greater than y \n(using the > operator). As x is 20, and y is 18, and we know that 20 is greater than 18, we print to the screen that \"x is greater than y\".",
                "heading": "Kotlin if"
            },
            {
                "content": "Use else to specify a block of code to be executed if the condition is false.\n\nSyntax\nif (condition) {\n // block of code to be executed if the condition is true\n} else {\n // block of code to be executed if the condition is false\n}\n\nExample\nval time = 20\nif (time < 18) {\n println(\"Good day.\")\n} else {\n println(\"Good evening.\")\n}\n// Outputs \"Good evening.\"\nTry it Yourself »\n\nExample explained\nIn the example above, time (20) is greater than 18, so the condition is false, \nso we move on to the else condition and print to the screen \"Good \nevening\". If the time was less than 18, the program would print \"Good day\".",
                "heading": "Kotlin else"
            },
            {
                "content": "Use else if to specify a new condition if the first condition is false.\n\nSyntax\nif (condition1) {\n // block of code to be executed if condition1 is true\n} else if (condition2) {\n // block of code to be executed if the condition1 is false and condition2 is true\n} else {\n // block of code to be executed if the condition1 is false and condition2 is false\n}\n\nExample\nval time = 22\nif (time < 10) {\n println(\"Good morning.\")\n} else if (time < 20) {\n println(\"Good day.\")\n} else {\n println(\"Good evening.\")\n}\n// Outputs \"Good evening.\"\nTry it Yourself »\n\nExample explained\nIn the example above, time (22) is greater than 10, so the first condition is false. The next condition, in the \nelse if statement, is also false, so we move on to the else\ncondition since condition1 and condition2 is both false - and print to the screen \"Good \nevening\".\n\nHowever, if the time was 14, our program would print \"Good day.\"",
                "heading": "Kotlin else if"
            },
            {
                "content": "In Kotlin, you can also use if..else statements as expressions \n(assign a value to a variable and return it):\n\nExample\nval time = 20\nval greeting = if (time < 18) {\n \"Good day.\"\n} else {\n \"Good evening.\"\n}\nprintln(greeting)\nTry it Yourself »\n\nWhen using if as an expression, you must also include else (required).\n\nNote: You can ommit the curly braces {} \nwhen if has only one statement:\n\nExample\nfun main() {\n val time = 20\n val greeting = if (time < 18) \"Good day.\" else \"Good evening.\"\n println(greeting)\n}\nTry it Yourself »\n\nTip: This example is similar to the \"ternary operator\" (short hand if...else) in Java.\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                "heading": "Kotlin If..Else Expressions"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_while_loop",
        "code_examples": [
            {
        ...
        "sections": [
            ...
            },
            {
                ...
                "heading": "Kotlin While Loop"
            },
            {
                "content": "The do..while loop is a variant of the while loop. This loop will \nexecute the code block once, before checking if the condition is true, then it will\nrepeat the loop as long as the condition is true.\n\nSyntax\ndo {\n // code block to be executed\n}\nwhile (condition);\n\nThe example below uses a do/while loop. The loop will always be \nexecuted at least once, even if the condition is false, because the code block \nis executed before the condition is tested:\n\nExample\nvar i = 0\ndo {\n println(i)\n i++\n }\nwhile (i < 5) \nTry it Yourself »\n\nDo not forget to increase the variable used in the condition, otherwise \nthe loop will never end!\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "content": "The break statement is used to jump out of a \nloop.\n\nThis example jumps out of the loop when i is equal to 4:\n\nExample\nvar i = 0\nwhile (i < 10) {\n println(i)\n i++\n if (i == 4) {\n break\n }\n}\nTry it Yourself »",
                "heading": "Kotlin Break"
            },
            {
                "content": "The continue statement breaks one iteration (in the loop), if a specified condition occurs, and continues with the next iteration in the loop.\n\nThis example skips the value of 4:\n\nExample\nvar i = 0\nwhile (i < 10) {\n if (i == 4) {\n i++\n continue\n }\n println(i)\n i++\n}\nTry it Yourself »",
                "heading": "Kotlin Continue"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "content": "Arrays are used to store multiple values in a single variable, instead of \ncreating separate variables for each \nvalue.\n\nTo create an array, use the arrayOf() function, and place the \nvalues in a comma-separated list inside it:\n\nval cars = arrayOf(\"Volvo\", \"BMW\", \"Ford\", \"Mazda\")",
                "heading": "Kotlin Arrays"
            },
            {
                "content": "You can access an array element by referring to the index number, \ninside square brackets.\n\nIn this example, we access the value of the first element in cars:\n\nExample\nval cars = arrayOf(\"Volvo\", \"BMW\", \"Ford\", \"Mazda\")\nprintln(cars[0])\n// Outputs Volvo \nTry it Yourself »\n\nNote: Just like with Strings, Array indexes start with 0: [0] is the first element. [1] is the second \nelement, etc.",
            ...
            {
                "content": "To find out how many elements an array have, use the size property:\n\nExample\nval cars = arrayOf(\"Volvo\", \"BMW\", \"Ford\", \"Mazda\")\nprintln(cars.size)\n// Outputs 4 \nTry it Yourself »",
                "heading": "Array Length / Size"
            },
            {
                "content": "You can use the in operator to check if an element exists in \nan array:\n\nExample\nval cars = arrayOf(\"Volvo\", \"BMW\", \"Ford\", \"Mazda\")\nif (\"Volvo\" in cars) {\n println(\"It exists!\")\n} else {\n println(\"It does not exist.\")\n}\nTry it Yourself »",
                "heading": "Check if an Element Exists"
            },
            {
                "content": "Often when you work with arrays, you need to loop through all of the \nelements.\n\nYou can loop through the array elements with the for \nloop, which you will learn even more about in the next chapter.\n\nThe following example outputs all elements in the cars \narray:\n\nExample\nval cars = arrayOf(\"Volvo\", \"BMW\", \"Ford\", \"Mazda\")\nfor (x in cars) {\n println(x)\n}\nTry it Yourself »\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
    ...
    },
    {
        ...
        "sections": [
            ...
            },
            {
                ...
                "heading": "Kotlin For Loop"
            },
            {
                "content": "Unlike Java and other programming languages, there is no traditional for loop \nin Kotlin.\n\nIn Kotlin, the for loop is used to loop through arrays, ranges, and other \nthings that contains a \ncountable number of values.\n\nYou will learn more about ranges in the next chapter - which \nwill create a range of values.",
                "heading": "Traditional For Loop"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
        ...
        "extracted_at": "2026-08-09T11:15:20Z",
        "subject": "Kotlin",
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "content": "With the for loop, you can also create \nranges of values with \"..\":\n\nExample\nPrint the whole alphabet:\n\nfor (chars in 'a'..'x') {\n println(chars)\n}\nTry it Yourself »\n\nYou can also create ranges of numbers:\n\nExample\nfor (nums in 5..15) {\n println(nums)\n} \nTry it Yourself »\n\nNote: The first and last value is included in the range.",
                "heading": "Kotlin Ranges"
            },
            {
                "content": "You can also use the in operator to check if a value exists in \na range:\n\nExample\nval nums = arrayOf(2, 4, 6, 8)\nif (2 in nums) {\n println(\"It exists!\")\n} else {\n println(\"It does not exist.\")\n}\nTry it Yourself »\n\nExample\nval cars = arrayOf(\"Volvo\", \"BMW\", \"Ford\", \"Mazda\")\nif (\"Volvo\" in cars) {\n println(\"It exists!\")\n} else {\n println(\"It does not exist.\")\n} \nTry it Yourself »",
                "heading": "Check if a Value Exists"
            },
            {
                "content": "You can also use the break and continue keywords in a range/for loop:\n\nExample\nStop the loop when nums is equal to 10:\n\nfor (nums in 5..15) {\n if (nums == 10) {\n break\n }\n println(nums)\n} \nTry it Yourself »\n\nExample\nSkip the value of 10 in the loop, and continue with the next iteration:\n\nfor (nums in 5..15) {\n if (nums == 10) {\n continue\n }\n println(nums)\n} \nTry it Yourself »\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                "heading": "Break or Continue a Range"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "content": "So it turns out you already know what a function is. You have been using it \nthe whole time through this tutorial!\n\nFor example, println() is a function. It is used to output/print text to the screen:\n\nExample\nfun main() {\n println(\"Hello World\")\n}\nTry it Yourself »",
                "heading": "Predefined Functions"
            },
            {
                "content": "To create your own function, use the fun keyword, and write the name of the \nfunction, followed by parantheses ():\n\nExample\nCreate a function named \"myFunction\" that should output some text:\n\nfun myFunction() {\n println(\"I just got executed!\")\n}",
                "heading": "Create Your Own Functions"
            },
            {
                "content": "Now that you have created a function, you can execute it by calling \nit.\n\nTo call a function in Kotlin, write the name of the function followed by two \nparantheses ().\n\nIn the following example, myFunction() will \nprint some text (the action), when it is called:\n\nExample\nfun main() {\n myFunction() // Call myFunction\n}\n\n// Outputs \"I just got executed!\" \nTry it Yourself »\n\nA function can be called multiple times, if you want:\n\nExample\nfun main() {\n myFunction()\n myFunction()\n myFunction()\n}\n\n// I just got executed!\n// I just got executed!\n// I just got executed! \nTry it Yourself »",
                "heading": "Call a Function"
            },
            {
                "content": "Information can be passed to functions as parameter.\n\nParameters are specified after the function name, inside the parentheses.\nYou can add as many parameters as you want, just separate them with a comma. \nJust note that you must specify the type of each parameter (Int, String, etc). \n\nThe following example has a \nfunction that takes a String called fname as parameter.\nWhen the function is called, we pass along a first name,\nwhich is used inside the function to print the full name:\n\nExample\nfun myFunction(fname: String) {\n println(fname + \" Doe\")\n}\n\nfun main() {\n myFunction(\"John\")\n myFunction(\"Jane\")\n myFunction(\"George\")\n}\n\n// John Doe\n// Jane Doe\n// George Doe \nTry it Yourself »\n\nWhen a parameter is passed to the function, it is called an argument. So, from the example above: fname is a parameter, while \nJohn, Jane and \nGeorge are arguments.",
                "heading": "Function Parameters"
            },
            {
                "content": "You can have as many parameters as you like:\n\nExample\nfun myFunction(fname: String, age: Int) {\n println(fname + \" is \" + age)\n}\n\nfun main() {\n myFunction(\"John\", 35)\n myFunction(\"Jane\", 32)\n myFunction(\"George\", 15)\n}\n\n// John is 35\n// Jane is 32\n// George is 15 \nTry it Yourself »\n\nNote: When working with multiple parameters, the function call must \nhave the same number of arguments as there are parameters, and the arguments must be passed in the same order.",
                "heading": "Multiple Parameters"
            },
            {
                "content": "In the examples above, we used functions to output a value. In the following example, we will use a function to \nreturn a value and assign it to a variable.\n\nTo return a value, use the return keyword, and specify the \nreturn type after \nthe function's parantheses (Int in this example):\n\nExample\nA function with one Int parameter, and Int return type:\n\nfun myFunction(x: Int): Int {\n return (x + 5)\n}\n\nfun main() {\n var result = myFunction(3)\n println(result)\n}\n\n// 8 (3 + 5) \nTry it Yourself »\n\nUsing two parameters:\n\nExample\nA function with two Int parameters, and Int return type:\n\nfun myFunction(x: Int, y: Int): Int {\n return (x + y)\n}\n\nfun main() {\n var result = myFunction(3, 5)\n println(result)\n}\n\n// 8 (3 + 5) \nTry it Yourself »",
                "heading": "Return Values"
            },
            {
                "content": "There is also a shorter syntax for returning values. You can use the = operator instead of return \nwithout specifying the return type. Kotlin is smart enough to automatically find out what it is:\n\nExample\n\nfun myFunction(x: Int, y: Int) = x + y\n\nfun main() {\n var result = myFunction(3, 5)\n println(result)\n}\n\n// 8 (3 + 5) \nTry it Yourself »\n\n ❮ Previous\n Next ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                "heading": "Shorter Syntax for Return Values"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    {
        "url": "https://www.w3schools.com/kotlin/kotlin_oop.php",
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_oop",
        "code_examples": [],
        "category": "Backend & Programming",
        "notes_and_tips": [],
        "sections": [
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_classes",
        "code_examples": [
            {
        ...
        "sections": [
            ...
            {
                "content": "Everything in Kotlin is associated with classes and objects, along with its properties and \nfunctions. For example: in real life, a car is an object. The car has properties, such as \nbrand, weight and color, and \nfunctions, such as drive and brake. \n\nA Class is like an object constructor, or a \"blueprint\" for creating objects.",
                "heading": "Kotlin Classes/Objects"
            },
            {
                "content": "To create a class, use the class keyword, and specify the name of the class:\n\nExample\nCreate a Car class along with some properties (brand, model and year)\n\nclass Car {\n var brand = \"\"\n var model = \"\"\n var year = 0\n} \n\nA property is basically a variable that belongs to the class.\n\n Good to Know: It is considered good practice to start the \n name of a class with an upper case letter, for better organization.",
                "heading": "Create a Class"
            },
            {
                "content": "Now we can use the class named Car to create objects.\n\nIn the example below, we create an object of Car called\nc1, and then we access the properties of c1 by \nusing the dot syntax (.), just like we did to \naccess array and string properties:\n\nExample\n// Create a c1 object of the Car class\nval c1 = Car()\n\n// Access the properties and add some values to it\nc1.brand = \"Ford\"\nc1.model = \"Mustang\"\nc1.year = 1969\n\nprintln(c1.brand)   // Outputs Ford\nprintln(c1.model)   // Outputs Mustang\nprintln(c1.year)    // Outputs 1969 \nTry it Yourself »",
                "heading": "Create an Object"
            },
            {
                "content": "You can create multiple objects of one class:\n\nExample\nval c1 = Car()\nc1.brand = \"Ford\"\nc1.model = \"Mustang\"\nc1.year = 1969\n\nval c2 = Car()\nc2.brand = \"BMW\"\nc2.model = \"X5\"\nc2.year = 1999\n\nprintln(c1.brand)  // Ford\nprintln(c2.brand)  // BMW\n\nTry it Yourself »\n\n ❮ Previous\n Next ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_constructors",
        "code_examples": [
            {
        ...
        "sections": [
            ...
            {
                "content": "In the previous chapter, we created an object of a class, and specified the properties inside the class, like this:\n\nExample\nclass Car {\n var brand = \"\"\n var model = \"\"\n var year = 0\n}\n\nfun main() {\n val c1 = Car()\n c1.brand = \"Ford\"\n c1.model = \"Mustang\"\n c1.year = 1969\n}\nTry it Yourself »\n\nIn Kotlin, there's a faster way of doing this, by using a constructor.\n\nA \nconstructor is like a special function, and it is defined by using two parantheses () \nafter the class name. You can specify the properties inside of the parantheses (like passing \nparameters into a regular function).\n\nThe constructor will initialize the properties when you create an object of a class. Just remember to specify the \ntype of the property/variable:\n\nExample\nclass Car(var brand: String, var model: String, var year: Int)\n\nfun main() {\n val c1 = Car(\"Ford\", \"Mustang\", 1969)\n}\nTry it Yourself »\n\nNow it's even easier to specify multiple objects of one class:\n\nExample\nclass Car(var brand: String, var model: String, var year: Int)\n\nfun main() {\n val c1 = Car(\"Ford\", \"Mustang\", 1969)\n val c2 = Car(\"BMW\", \"X5\", 1999)\n val c3 = Car(\"Tesla\", \"Model S\", 2020)\n}\nTry it Yourself »",
                "heading": "Kotlin Constructor"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_class_functions",
        "code_examples": [
            {
                "code": "Example\nCreate a drive() function inside the \nCar class and call it:\n\nclass Car(var brand: String, var model: String, var year: Int) {\n // Class function\n fun drive() {\n println(\"Wrooom!\")\n }\n}\n\nfun main() {\n val c1 = Car(\"Ford\", \"Mustang\", 1969)\n\n // Call the function\n c1.drive()\n}\nTry it Yourself »\n\nTip: When a function is declared inside a class, it is known as a class function, or \nmember function.\n\nNote: When an object of the class is created, it has access to all of the class functions.\n\nClass Function Parameters\nJust like with regular functions, you can pass parameters to a class function:\n\nExample\nCreate two functions: drive() and speed(), and pass parameters to the \nspeed() function:\n\nclass Car(var brand: String, var model: String, var year: Int) {\n // Class function\n fun drive() {\n println(\"Wrooom!\")\n }\n\n // Class function with parameters\n fun speed(maxSpeed: Int) {\n println(\"Max speed is: \" + maxSpeed)\n }\n}\n\nfun main() {\n val c1 = Car(\"Ford\", \"Mustang\", 1969)\n\n // Call the functions\n c1.drive()\n c1.speed(200)\n}\nTry it Yourself »\n\nAdvertisement\n -->\n\n ❮ Previous\n Next ❯\n\n ★\n\n +1\n\n Sign in to track progress",
                "language": "kotlin",
                "heading": "Example",
                "tryit_url": null
            }
        ...
        "sections": [
            ...
            {
                "content": "You can also use functions inside a class, to perfom certain actions:\n\nExample\nCreate a drive() function inside the \nCar class and call it:\n\nclass Car(var brand: String, var model: String, var year: Int) {\n // Class function\n fun drive() {\n println(\"Wrooom!\")\n }\n}\n\nfun main() {\n val c1 = Car(\"Ford\", \"Mustang\", 1969)\n\n // Call the function\n c1.drive()\n}\nTry it Yourself »\n\nTip: When a function is declared inside a class, it is known as a class function, or \nmember function.\n\nNote: When an object of the class is created, it has access to all of the class functions.",
                "heading": "Kotlin Class Functions"
            },
            {
                "content": "Just like with regular functions, you can pass parameters to a class function:\n\nExample\nCreate two functions: drive() and speed(), and pass parameters to the \nspeed() function:\n\nclass Car(var brand: String, var model: String, var year: Int) {\n // Class function\n fun drive() {\n println(\"Wrooom!\")\n }\n\n // Class function with parameters\n fun speed(maxSpeed: Int) {\n println(\"Max speed is: \" + maxSpeed)\n }\n}\n\nfun main() {\n val c1 = Car(\"Ford\", \"Mustang\", 1969)\n\n // Call the functions\n c1.drive()\n c1.speed(200)\n}\nTry it Yourself »",
                "heading": "Class Function Parameters"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
        ...
        "extracted_at": "2026-08-09T11:15:21Z",
        "subject": "Kotlin",
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_inheritance",
        "code_examples": [
            {
        ...
        "sections": [
            ...
            {
                "content": "In Kotlin, it is possible to inherit class properties and functions from one class to another. We group the \"inheritance concept\" into two categories:\n\nsubclass (child) - the class that inherits from another class\n\nsuperclass (parent) - the class being inherited from\n\nIn the example below, MyChildClass (subclass) inherits the \nproperties from the \nMyParentClass class \n(superclass):\n\nExample\n// Superclass\nopen class MyParentClass {\n val x = 5\n}\n\n// Subclass\nclass MyChildClass: MyParentClass() {\n fun myFunction() {\n println(x) // x is now inherited from the superclass\n }\n}\n\n// Create an object of MyChildClass and call myFunction\nfun main() {\n val myObj = MyChildClass()\n myObj.myFunction()\n} \nTry it Yourself »",
                "heading": "Kotlin Inheritance (Subclass and Superclass)"
            },
            {
                "content": "Use the open keyword in front of the superclass/parent, \nto make this the class other classes should inherit properties and functions from.\n\nTo inherit from a class, specify the name of the subclass, followed by a colon :, \nand then the name of the superclass.\n\nWhy And When To Use \"Inheritance\"?\n- It is useful for code reusability: reuse properties and functions of an existing class when you create a new class.",
    ...
    {
        "url": "https://www.w3schools.com/kotlin/kotlin_exam.php",
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_exam",
        "code_examples": [],
        "category": "Backend & Programming",
        "notes_and_tips": [],
        "sections": [
    ...
    {
        "url": "https://www.w3schools.com/kotlin/kotlin_examples.php",
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_examples",
        "code_examples": [],
        "category": "Backend & Programming",
        "notes_and_tips": [],
        "sections": [
        ...
        "extracted_at": "2026-08-09T11:15:22Z",
        "subject": "Kotlin",
    ...
    },
    {
        ...
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_compiler",
        "code_examples": [],
        "category": "Backend & Programming",
        "notes_and_tips": [],
        "sections": [
            ...
            {
                "content": "With our online Kotlin compiler, you can edit Kotlin code, and view the result in your browser.\n\nfun main() {\n println(\"Hello World\")\n}\n\n Hello World\n\n Try it Yourself »\n\nClick on the \"Try it Yourself\" button to see how it works.\n\n If you don't know Kotlin, we suggest that you read our Kotlin Tutorial from scratch.\n\n ❮ Previous\n Next ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                "heading": "Kotlin Compiler (Editor)"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    {
        "url": "https://www.w3schools.com/kotlin/kotlin_exercises.php",
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_exercises",
        "code_examples": [],
        "category": "Backend & Programming",
        "notes_and_tips": [],
        "sections": [
            ...
            },
            {
                ...
                "heading": "Start Kotlin Exercises"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
                "heading": "Create a W3Schools Account"
    ...
    {
        "url": "https://www.w3schools.com/kotlin/kotlin_quiz.php",
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_quiz",
        "code_examples": [],
        "category": "Backend & Programming",
        "notes_and_tips": [],
        "sections": [
    ...
    {
        "url": "https://www.w3schools.com/kotlin/kotlin_practice.php",
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_practice",
        "code_examples": [],
        "category": "Backend & Programming",
        "notes_and_tips": [],
        "sections": [
        ...
        "extracted_at": "2026-08-09T11:15:22Z",
        "subject": "Kotlin",
        "title": "Practice Kotlin Coding Problems"
    },
    {
        "url": "https://www.w3schools.com/kotlin/kotlin_syllabus.php",
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_syllabus",
        "code_examples": [
            {
        ...
        "sections": [
            ...
            },
            {
                ...
                "heading": "Which Subjects Are Kotlin Relevant For?"
            },
            {
                "content": "In this tutorial we offer different activities for you to learn Kotlin for free:\n\n Lessons\n\n Exercises\n\n Quizzes",
                "heading": "Activities"
            },
            {
        ...
        "extracted_at": "2026-08-09T11:15:23Z",
        "subject": "Kotlin",
        "title": "Kotlin Syllabus"
    },
    {
        "url": "https://www.w3schools.com/kotlin/kotlin_study_plan.php",
        "summary": "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, PHP, Python, Bootstrap, Java and XML.",
        "topic_id": "kotlin_kotlin_study_plan",
        "code_examples": [],
        "category": "Backend & Programming",
        "notes_and_tips": [],
        "sections": [
            ...
            {
                "content": "Start with Kotlin Study Plans today.\n\nGet Started »",
                "heading": "Ready to get started?"
            },
            {
                "content": "Are you interested in learning how you can use W3Schools Academy to Teach Kotlin programming? \n\nWatch a demo of W3Schools Academy. You'll see how it works, and discover how it can make teaching programming easier and more engaging.\n\nWatch Demo »\n\n ❮ Previous\n Next ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                "heading": "Are You a Teacher?"
            },
            {
                "content": "Ad-free learning, track your progress, earn XP, streaks, compete in leagues,\nbuild and host websites, unlock coding challenges, and much more! \n\n Earn XP\n\n Streaks\n\n Leagues\n\n Your Own Space\n\n Sign Up for Free\n\n Your Progress\n 0%\n\n 0 / 50 lessons\n\n 0 / 100 challenges\n\nPLUS\n\nSPACES\n\nGET CERTIFIED\n\nFOR TEACHERS\n\nPRACTICE\n\nCONTACT US\n\n ×",
        ...
        "extracted_at": "2026-08-09T11:15:24Z",
        "subject": "Kotlin",
