...
window.DEVDOCS_SUBJECTS['pandas'] = [
    {
        ...
        "extracted_at":  "2026-08-09T11:16:09Z",
        "subject":  "Pandas",
    ...
    },
    {
        ...
        "extracted_at":  "2026-08-09T11:16:10Z",
        "subject":  "Pandas",
    ...
    },
    {
        ...
        "extracted_at":  "2026-08-09T11:16:11Z",
        "subject":  "Pandas",
        "title":  "CSS Tutorial"
    },
    {
    ...
    },
    {
        ...
        "extracted_at":  "2026-08-09T11:16:12Z",
        "subject":  "Pandas",
    ...
    },
    {
        ...
        "extracted_at":  "2026-08-09T11:16:13Z",
        "subject":  "Pandas",
    ...
    },
    {
        ...
        "extracted_at":  "2026-08-09T11:16:14Z",
        "subject":  "Pandas",
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_getting_started.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_getting_started",
        "code_examples":  [
                              {
                                  "code":  "C:\\Users\\Your Name\u003epip install pandas",
                                  "language":  "pandas",
                                  "heading":  "Example",
                                  "tryit_url":  null
                              },
        ...
        "sections":  [
                         ...
                         {
                             "content":  "If you have Python and PIP already installed on a system, then installation of Pandas is very easy.\n\nInstall it using this command:\n\nC:\\Users\\Your Name\u003epip install pandas\n\nIf this command fails, then use a python distribution that already has Pandas installed like, Anaconda, Spyder etc.",
                             "heading":  "Installation of Pandas"
                         },
                         {
                             "content":  "Once Pandas is installed, import it in your applications by adding the\nimport keyword:\n\nimport pandas\n\nNow Pandas is imported and ready to use.\n\nExample\n\n import pandas\n\nmydataset = {\n  \u0027cars\u0027: [\"BMW\", \"Volvo\", \"Ford\"],\n\n  \u0027passings\u0027: [3, 7, 2]\n}\n\nmyvar = pandas.DataFrame(mydataset)\n\nprint(myvar)\n\nTry it Yourself »",
                             "heading":  "Import Pandas"
                         },
                         {
                             "content":  "Pandas is usually imported under the pd \nalias.\n\n alias: In Python alias are an alternate name for referring \n to the same thing.\n\nCreate an alias with the as keyword while importing:\n\nimport pandas as pd\n\nNow the Pandas package can be referred to as pd instead of \npandas.\n\nExample\n\nimport pandas as pd\n\nmydataset = {\n  \u0027cars\u0027: [\"BMW\", \"Volvo\", \"Ford\"], \n  \u0027passings\u0027: \n [3, 7, 2]\n}\n\nmyvar = pd.DataFrame(mydataset)\n\nprint(myvar)\n\nTry it Yourself »",
                             "heading":  "Pandas as pd"
                         },
                         {
                             "content":  "The version string is stored under __version__ \nattribute.\n\nExample\n\n import pandas as pd\n\nprint(pd.__version__)\n\nTry it Yourself »\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                             "heading":  "Checking Pandas Version"
                         },
                         {
                             "content":  "If you want to use W3Schools services as an educational institution, team or enterprise, send us an e-mail:\nsales@w3schools.com",
                             "heading":  "Contact Sales"
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_series.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_series",
        "code_examples":  [
                              {
                                  "code":  "import pandas as pd\n\na = [1, 7, 2]\n\nmyvar = pd.Series(a)\n\nprint(myvar)",
                                  "language":  "pandas",
        ...
        "sections":  [
                         ...
                         {
                             "content":  "A Pandas Series is like a column in a table.\n\nIt is a one-dimensional array holding data of any type.\n\nExample\n Create a simple Pandas Series from a list:\n\nimport pandas as pd\n\na = [1, 7, 2]\n\nmyvar = pd.Series(a)\n\nprint(myvar)\n\nTry it Yourself »",
                             "heading":  "What is a Series?"
                         },
                         {
                             "content":  "If nothing else is specified, the values are labeled with their index number. First value \nhas index 0, second value has index 1 etc.\n\nThis label can be used to access a specified value.\n\nExample\n Return the first value of the Series:\n\nprint(myvar[0])\n\nTry it Yourself »",
                             "heading":  "Labels"
                         },
                         {
                             "content":  "With the index argument, you can name your own labels.\n\nExample\n Create your own labels:\n\nimport pandas as pd\n\na = [1, 7, 2]\n\nmyvar = pd.Series(a, index = [\"x\", \"y\", \"z\"])\n\nprint(myvar)\n\nTry it Yourself »\n\nWhen you have created labels, you can access an item by referring to the label.\n\nExample\n Return the value of \"y\":\n\n print(myvar[\"y\"])\n\nTry it Yourself »",
                             "heading":  "Create Labels"
                         },
                         {
                             "content":  "You can also use a key/value object, like a dictionary, when creating a Series.\n\nExample\n Create a simple Pandas Series from a dictionary:\n\nimport pandas as pd\n\ncalories = {\"day1\": 420, \"day2\": 380, \"day3\": \n 390}\n\nmyvar = pd.Series(calories)\n\nprint(myvar)\n\nTry it Yourself »\n\n Note: The keys of the dictionary become the labels.\n\nTo select only some of the items in the dictionary, use the index \nargument and specify only the items you want to include in the Series.\n\nExample\n Create a Series using only data from \"day1\" and \"day2\":\n\nimport pandas as pd\n\ncalories = {\"day1\": 420, \"day2\": 380, \"day3\": \n 390}\n\nmyvar = pd.Series(calories, \n index = [\"day1\", \"day2\"])\n\nprint(myvar)\n\nTry it Yourself »",
                             "heading":  "Key/Value Objects as Series"
                         },
                         {
                             "content":  "Data sets in Pandas are usually multi-dimensional tables, called DataFrames.\n\nSeries is like a column, a DataFrame is the whole table.\n\nExample\n Create a DataFrame from two Series:\n\nimport pandas as pd\n\ndata = {\n  \"calories\": [420, 380, 390],\n  \"duration\": \n [50, 40, 45]\n}\n\nmyvar = pd.DataFrame(data)\n\nprint(myvar)\n\nTry it Yourself »\n\nYou will learn about DataFrames in the next chapter.\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                             "heading":  "DataFrames"
                         },
                         {
                             "content":  "If you want to use W3Schools services as an educational institution, team or enterprise, send us an e-mail:\nsales@w3schools.com",
        ...
        "extracted_at":  "2026-08-09T11:16:15Z",
        "subject":  "Pandas",
        "title":  "Pandas Series"
    },
    {
        ...
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_dataframes",
        "code_examples":  [
                              {
        ...
        "sections":  [
                         ...
                         {
                             "content":  "A Pandas DataFrame is a 2 dimensional data structure, like a 2 dimensional \narray, or a table with rows and columns.\n\n Example\n Create a simple Pandas DataFrame:\n\nimport pandas as pd\n\ndata = {\n  \"calories\": [420, 380, 390],\n  \"duration\": \n [50, 40, 45]\n}\n\n#load data into a DataFrame object:\ndf = pd.DataFrame(data)\n\nprint(df)",
                             "heading":  "What is a DataFrame?"
                         },
                         {
                             "content":  "calories duration\n 0 420 50\n 1 380 40\n 2 390 45\n\nTry it Yourself »",
                             "heading":  "Result"
                         },
                         {
                             "content":  "As you can see from the result above, the DataFrame is like a table with rows and columns.\n\nPandas use the loc attribute to return \none or more specified row(s)\n\n Example\n Return row 0:\n\n#refer to the row index:\n\nprint(df.loc[0])",
                             "heading":  "Locate Row"
                         },
                         {
                             "content":  "calories 420\n duration 50\n Name: 0, dtype: int64\n\nTry it Yourself »\n\n Note: This example returns a Pandas Series.\n\n Example\n Return row 0 and 1:\n\n#use a list of indexes:\n\nprint(df.loc[[0, 1]])",
                             "heading":  "Result"
                         },
                         {
                         ...
                         {
                             "content":  "With the index argument, you can name your own indexes.\n\n Example\n Add a list of names to give each row a name:\n\nimport pandas as pd\n\ndata = {\n  \"calories\": [420, 380, 390],\n  \"duration\": \n [50, 40, 45]\n}\n\ndf = pd.DataFrame(data, index = [\"day1\", \"day2\", \n \"day3\"])\n\nprint(df)",
                         ...
                         {
                             "content":  "Use the named index in the loc attribute to return the specified row(s).\n\n Example\n Return \"day2\":\n\n#refer to the named index:\n\nprint(df.loc[\"day2\"])",
                             "heading":  "Locate Named Indexes"
                         },
                         {
                             "content":  "calories 380\n duration 40\n Name: day2, dtype: int64\n\nTry it Yourself »",
                             "heading":  "Result"
                         },
                         {
                             "content":  "If your data sets are stored in a file, Pandas can load them into a DataFrame.\n\n Example\n Load a comma separated file (CSV file) into a DataFrame:\n\n import pandas as pd\n\ndf = pd.read_csv(\u0027data.csv\u0027)\n\nprint(df) \n\nTry it Yourself »\n\n You will learn more about importing files in the next chapters.\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                             "heading":  "Load Files Into a DataFrame"
                         },
                         {
                             "content":  "If you want to use W3Schools services as an educational institution, team or enterprise, send us an e-mail:\nsales@w3schools.com",
                             "heading":  "Contact Sales"
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_json.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_json",
        "code_examples":  [
                              {
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_analyzing.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_analyzing",
        "code_examples":  [
                              {
                                  "code":  "import pandas as pd\n\ndf = pd.read_csv(\u0027data.csv\u0027)\n\nprint(df.head(10))",
                                  "language":  "pandas",
    ...
    },
    {
        ...
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_cleaning",
        "code_examples":  [
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_cleaning_empty_cells.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_cleaning_empty_cells",
        "code_examples":  [
                              {
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_cleaning_wrong_format.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_cleaning_wrong_format",
        "code_examples":  [
                              {
        ...
        "extracted_at":  "2026-08-09T11:16:16Z",
        "subject":  "Pandas",
        "title":  "Pandas - Cleaning Data of Wrong Format"
    },
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_cleaning_wrong_data.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_cleaning_wrong_data",
        "code_examples":  [
                              {
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_cleaning_duplicates.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_cleaning_duplicates",
        "code_examples":  [
                              {
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_correlations.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_correlations",
        "code_examples":  [
                              {
                                  "code":  "df.corr()",
                                  "language":  "pandas",
        ...
        "extracted_at":  "2026-08-09T11:16:17Z",
        "subject":  "Pandas",
        "title":  "Pandas - Data Correlations"
    },
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_plotting.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_plotting",
        "code_examples":  [
                              {
                                  "code":  "import pandas as pd\nimport matplotlib.pyplot as plt\n\ndf = pd.read_csv(\u0027data.csv\u0027)\n\ndf.plot()\n\nplt.show()",
                                  "language":  "pandas",
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_exam.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_exam",
        "code_examples":  [
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_compiler.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_compiler",
        "code_examples":  [
        ...
        "sections":  [
                         ...
                         {
                             "content":  "With our \"Try it Yourself\" editor, you can edit Python code and use the Pandas module, and view the result in your browser.\n\nimport pandas as pd\n\ndf = pd.read_csv(\u0027data.csv\u0027)\n\nprint(df.to_string())\n\n Duration Pulse Maxpulse Calories\n0 60 110 130 409.1\n1 60 117 145 479.0\n2 60 103 135 340.0\n\n Try it Yourself »\n\nClick on the \"Try it Yourself\" button to see how it works.",
                             "heading":  "Pandas (Python) Editor"
                         },
                         {
                             "content":  "If you want to create your own website or build Python applications, W3Schools Spaces gives you an easy place to write, run, manage, and publish code online.\n\n If you don\u0027t know Python, we suggest that you read our Python Tutorial from scratch.\n\n ❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                             "heading":  "Build and Publish Pandas Projects"
                         },
                         {
                             "content":  "If you want to use W3Schools services as an educational institution, team or enterprise, send us an e-mail:\nsales@w3schools.com",
                             "heading":  "Contact Sales"
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_quiz.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_quiz",
        "code_examples":  [
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_exercises.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_exercises",
        "code_examples":  [
        ...
        "sections":  [
                         ...
                         {
                             "content":  "OpenDone",
                             "heading":  "Getting Started3 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Series4 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "DataFrame9 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Read CSV3 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Read JSON3 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Analyzing DataFrames3 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Cleaning Empty Cells4 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Cleaning Wrong Format2 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Cleaning Wrong Data2 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Cleaning Duplicates3 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Correlations3 exercises"
                         },
                         {
                             "content":  "OpenDone",
                             "heading":  "Plotting5 exercises"
                         },
                         {
    ...
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_syllabus.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_syllabus",
        "code_examples":  [
                              {
                                  "code":  "import pandas as pd\n\ndf = pd.read_csv(\u0027data.csv\u0027)\n\nprint(df.to_string())",
                                  "language":  "pandas",
        ...
        "sections":  [
                         ...
                         {
                             "content":  "The\n W3Schools Pandas Tutorial\n is comprehensive and beginner-friendly.\n\nIt will give you a fundamental knowledge of Pandas.\n\nIt is designed for beginners and requires only basic Python knowledge.\n\n The content has been carefully made to be bite-sized, simple, and easy to\n understand.\n\n The content has been proven by millions of users over the years. It is updated\n and improved frequently.\n\n The syllabus outline and its sequence are structured so you can learn Pandas\n step by step, from the introduction to data analysis.\n\n Get Started With Pandas »",
                             "heading":  "Introduction"
                         },
                         {
                             "content":  "Understand the basic structure of Pandas DataFrames and Series.\n\n Load and manipulate data from various sources.\n\n Clean and preprocess data effectively.\n\n Perform data analysis and aggregation.\n\n Handle missing data appropriately.\n\n Create data visualizations.\n\n Work with time series data.\n\n Merge and join datasets.\n\n Export data to different formats.\n\n Note: Are you a teacher teaching Pandas?\n W3Schools Academy\n is a toolbox of features that can help you teach. It offers classroom\n features such as pre-built study plans, classroom administration and much\n more. Read more about\n Academy here.",
                         ...
                         },
                         {
                             ...
                             "heading":  "Which Subjects Are Pandas Relevant For?"
                         },
                         {
                             "content":  "In this tutorial we offer different activities for you to learn Pandas for\n free:\n\n Lessons\n\n Exercises\n\n Quizzes",
                             "heading":  "Activities"
                         },
                         {
                         ...
                         {
                             "content":  "Pandas, like any other library, is best learned through hands-on practice.\n\nTry this example using our editor:\n\n Example\n Load a CSV file into a Pandas DataFrame:\n\n import pandas as pd\n\ndf = pd.read_csv(\u0027data.csv\u0027)\n\nprint(df.to_string()) \n\nTry it Yourself »\n\n If you want to explore more and host your project, we have a feature called\n Spaces that allows you to\n build, test and deploy Python projects.\n\n Here you get a secure sandbox environment called Spaces, where you can\n practice Pandas code and test projects in real-time.\n\n Spaces allow you to test, build, and deploy code. This includes a W3Schools\n subdomain, hosting, and secure SSL certificates.\n\nSpaces require no installation and run directly in the browser.\n\nFeatures include:\n\n Collaboration\n\n File navigator\n\n Terminal \u0026 log\n\n Package manager\n\n Database\n\n Environment manager\n\n Analytics\n\n Create a Spaces Account",
                             "heading":  "Sandbox and Lab Environment"
                         },
                         {
                             "content":  "W3Schools offers an end-of-pathway certification program.\n\nHere you can take exams to get certified.\n\nThe Pandas exam is a test that summarizes the W3Schools Pandas syllabus.\n\n After passing the exam you get the \"Certified Pandas Developer\" Certification.\n\nThere are two different types of certifications:\n\n Non-adaptive\n\n Adaptive\n\nThe non-adaptive is pass or no pass.\n\n The adaptive certification is adaptive and graded; students will get a grade\n from intermediate, advanced to professional.\n\n Buy Certificate »",
                             "heading":  "Pandas Certification"
                         },
                         {
                             "content":  "Are you interested in learning how you can use\n W3Schools Academy\n to Teach Pandas?\n\n Watch a demo of\n W3Schools Academy.\n You\u0027ll see how it works, and discover how it can make teaching programming\n easier and more engaging.\n\n Watch Demo »\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
        ...
        "extracted_at":  "2026-08-09T11:16:18Z",
        "subject":  "Pandas",
        "title":  "Pandas Syllabus"
    },
    {
        "url":  "https://www.w3schools.com/python/pandas/pandas_study_plan.asp",
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_study_plan",
        "code_examples":  [
        ...
        "sections":  [
                         ...
                         {
                             "content":  "Start with Pandas Study Plans today.\n\nGet Started »",
                             "heading":  "Ready to get started?"
                         },
                         {
                             "content":  "Are you interested in learning how you can use W3Schools Academy to Teach Pandas programming? \n\nWatch a demo of W3Schools Academy. You\u0027ll see how it works, and discover how it can make teaching programming easier and more engaging.\n\nWatch Demo »\n\n❮ Previous\nNext ❯\n\n ★\n\n +1\n\n Sign in to track progress\n\n REMOVE ADS",
                             "heading":  "Are You a Teacher?"
                         },
                         {
                             "content":  "If you want to use W3Schools services as an educational institution, team or enterprise, send us an e-mail:\nsales@w3schools.com",
    ...
    },
    {
        ...
        "summary":  "Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.",
        "topic_id":  "pandas_pandas_ref_dataframe",
        "code_examples":  [
